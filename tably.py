...
# CREDIT: narimiran et al, https://github.com/narimiran/tably
# Minimal editing by Emma Tarmey for specific use case
...
# edited to remove header pieces
#HEADER = r"""\begin{{tabular}}{{@{{}}{align}@{{}}}}
#{indent}\toprule"""
HEADER = r"""\begin{{tabular}}{{@{{}}{align}@{{}}}}
{indent}\toprule"""

# edited to remove footer pieces
#FOOTER = r"""{indent}\bottomrule
#\end{{tabular}}"""
FOOTER = r"""{indent}\bottomrule
\end{{tabular}}"""
