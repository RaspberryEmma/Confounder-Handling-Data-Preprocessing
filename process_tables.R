...
for (step_off_on in c(0)) {
  ...
  for (i in 1:8) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  ...
  for (i in 1:8) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  ...
  for (i in 1:8) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  ...
  for (i in 1:8) { lasso_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  ...
  for (i in 1:8) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  ...
  for (i in 1:8) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_1_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_2_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_3_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_4_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_5_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_6_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_7_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_8_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
  ...
  linear_full_blocked_percentage <- c()
  for (i in 1:num_computed) { linear_full_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["linear", "blocked_paths"] / total_confounders[i] }
  
  stepwise_blocked <- c()
  for (i in 1:num_computed) { stepwise_blocked[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["stepwise", "blocked_paths"] }
  
  stepwise_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["stepwise", "blocked_paths"] / total_confounders[i] }
  
  stepwise_X_blocked <- c()
  for (i in 1:num_computed) { stepwise_X_blocked[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["stepwise_X", "blocked_paths"] }
  
  stepwise_X_blocked_percentage <- c()
  for (i in 1:num_computed) { stepwise_X_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["stepwise_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_blocked <- c()
  for (i in 1:num_computed) { lasso_blocked[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] }
  
  lasso_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso", "blocked_paths"] / total_confounders[i] }
  
  lasso_X_blocked <- c()
  for (i in 1:num_computed) { lasso_X_blocked[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] }
  
  lasso_X_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_X_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso_X", "blocked_paths"] / total_confounders[i] }
  
  lasso_union_blocked <- c()
  for (i in 1:num_computed) { lasso_union_blocked[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] }
  
  lasso_union_blocked_percentage <- c()
  for (i in 1:num_computed) { lasso_union_blocked_percentage[i] <- get( paste0( "scenario_9_confset_", i, "_data"))["two_step_lasso_union", "blocked_paths"] / total_confounders[i] }
